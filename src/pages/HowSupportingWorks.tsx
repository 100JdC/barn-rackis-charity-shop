          ...
          <Card className="bg-white/90 backdrop-blur-sm">
            ...
            <CardContent className="space-y-6 text-lg">
              <div className="text-center text-gray-600">
                <p>Content coming soon! We're working on detailed information about how you can support our mission.</p>
                <p className="mt-4">Check back soon for various ways to help children with cancer through our platform.</p>
              </div>
            </CardContent>
          </Card>
        </div>
